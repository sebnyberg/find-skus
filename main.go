...
var (
	...
	memoryMin                     = flag.Uint64("min-memory", 0, "Minimum memory in GB")
	memoryMax                     = flag.Uint64("max-memory", 0, "Maximum memory in GB")
	cpu                           = flag.Uint64("cpu", 0, "vCPUs")
	cpuMin                        = flag.Uint64("min-cpu", 0, "Minimum vCPUs")
	cpuMax                        = flag.Uint64("max-spu", 0, "Maximum vCPUs")
	...
	zonesMin                      = flag.Uint64("min-zones", 0, "Minimum SKU AZs")
